...
if __name__ == '__main__':
    ...
    state_dim = env.observation_space.shape[0] - 1 #state is angle and angular velocity not cartesian coordinates and angular velocity
    ...
    for cycles in range(NB_TRAINING_CYCLES):
        ...
        for t in range(training_steps):
            ...
            if t < warm_up:
                ...
                noisy_action = cpu_action + expected_action.detach().numpy()
    ...
    train_losses.to_csv('Data/CSVs/P(a|s)NoiseTraining_MLE.csv')

    if PLOTTING:
        pasa_ddpg = DDPGMetrics(file_path='Data/CSVs/P(a|s)NoiseTraining_MLE.csv', show=True, title='P(a[k]|s[k]) Noise')
